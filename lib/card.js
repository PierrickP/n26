...
class Card {
  constructor(account, card) {
    ...
    this.blocked = (["M_DISABLED","BLOCKED"].indexOf(this.n26Status) != -1);
    this.panEnding = this.maskedPan.slice(-4);
    this.date_activation = new Date(this.cardActivated);
    this.date_expiration = new Date(this.expirationDate);
  }
